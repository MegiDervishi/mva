...
def load_dataset():
    ...
    ##################
    #filter
    """sessions_train2, sessions_test2 = [], []
    for i in sessions_train:
        if len(i)!=1: sessions_train2.append(i)
    for i in sessions_test:
        if len(i)!=1: sessions_test2.append(i)
    """
...
#load_dataset()
""" ---- Answer for Task 8 ----
Number training sesssion: 719470
Number testing sesssion: 60858
Max train item: 43096
Max test item: 43097
Unique train items: 42973
Unique test items: 18646
"""
